      ...
      <section className="bg-black py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            >
              <div className="w-14 h-14 rounded-2xl bg-purple-accent/20 flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-purple-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            >
              <div className="w-14 h-14 rounded-2xl bg-orange-primary/20 flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-orange-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 2a7 7 0 017 7c0 2.5-1.5 4.5-3 6l-4 5-4-5c-1.5-1.5-3-3.5-3-6a7 7 0 017-7z" />
                </svg>
              </div>
